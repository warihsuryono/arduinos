...
void loop() {
  ...
  float rs = 20000.0 * ((1023.0 / analogRead(A0)) - 1.0);
  float AIN3 = rs/20000.0;

  rs = 47000.0 * ((1023.0 / analogRead(A1)) - 1.0);
  float AIN4 = rs/47000.0;
  ...
  Serial.println(String((AVG_AIN0*2.048/16777216), 6) + ";" + String((AVG_AIN1*2.048/16777216), 6) + ";" + String((AVG_AIN2*2.048/16777216), 6) + ";" + String(AIN3, 10) + ";" + String(AIN4, 10) + ";" + String((AVG_AIN5*2.048/16777216), 6) + ";" + String((AVG_AIN6*2.048/16777216), 6) + ";" + String((AVG_AIN7*2.048/16777216), 6) + ";");
